    ...
    return (
      <div class="container my-3">
        ...
        {this.state.articles.map((element)=>{
          ...
          <NewsItems  name={element.name} description={element.description} origin={element.origin} imageUrl={element.cfa_url} vetstreet={element.vetstreet_url}/>
        </div>
        })}
        </div>
        </InfiniteScroll>
